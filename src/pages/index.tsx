  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless navigation and personalized learning with HR Management System. Offering customized typing lessons, interactive exercises, and real-time progress tracking, all within a user-friendly interface. Engage, learn, and grow with our community while enjoying quality, regularly updated content. Optimized for all devices, for a consistent learning experience."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0eXBpbmclMjBsZXNzb25zfGVufDB8fHx8MTY5MTg1NDI1NXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless navigation and personalized learning with HR Management System. Offering customized typing lessons, interactive exercises, and real-time progress tracking, all within a user-friendly interface. Engage, learn, and grow with our community while enjoying quality, regularly updated content. Optimized for all devices, for a consistent learning experience.`}
            </Text>
            <Box
